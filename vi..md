...
Phiên bản vá lỗi Z (x.y.Z | x > 0) phải được tăng lên nếu chỉ sửa các lỗi tương thích đã được đưa ra. A bug fix is defined as an internal change that fixes incorrect behavior.
